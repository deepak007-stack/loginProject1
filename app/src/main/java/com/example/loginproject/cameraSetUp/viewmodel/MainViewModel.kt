package com.example.loginproject.cameraSetUp.viewmodel
...
import com.example.loginproject.cameraSetUp.api.FileApi
...
@HiltViewModel
class MainViewModel @Inject constructor(private val dao: ImageRepository) : ViewModel() {
